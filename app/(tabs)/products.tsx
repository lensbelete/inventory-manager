    ...
    <SafeAreaView className="flex-1 bg-slate-950" edges={['top', 'left', 'right']}>
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <Text className="pt-2 text-2xl font-semibold text-slate-100">Products</Text>
          <Text className="mt-1 text-sm text-slate-400">
            Register catalog items, then adjust stock. Inventory cannot drop below zero.
          </Text>

          <View className="mt-6 rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
            <Text className="mb-3 text-xs font-medium uppercase tracking-wide text-slate-500">New product</Text>
            ...
            <View className="mb-3 flex-row gap-3">
              ...
              <View className="flex-1">
                <Text className="mb-1 text-xs text-slate-400">Initial qty</Text>
                <TextInput
                  className="rounded-xl border border-slate-700 bg-slate-950 px-3 py-2.5 text-base text-slate-100"
                  placeholder="0"
                  placeholderTextColor="#64748b"
          ...
          <Text className="mb-3 mt-10 text-xs font-medium uppercase tracking-wide text-slate-500">
            Inventory status
          </Text>
          {products.length === 0 ? (
          ...
          {products.map((p) => (
            <View
              ...
              <Text className="mt-2 text-sm text-slate-300">
                <Text className="text-slate-500">Qty </Text>
              ...
              <Text className="mb-1 mt-4 text-xs font-medium uppercase tracking-wide text-slate-500">
                Adjust stock
              </Text>
              <TextInput
